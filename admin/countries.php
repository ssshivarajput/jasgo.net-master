<?php include 'check.php'; $pageurl="countries"; $tbl_name="countries"; $mintablewidth="950px";  $utype="Countries"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>Country Name</td>";  
