<?php include 'check.php'; $pageurl="features"; $tbl_name="features"; $mintablewidth="950px";  $utype="features"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addfeatures<?php echo $extn ?>', 'myPop1',400,350);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td width='30'><input type='checkbox' id='selectall' title='Select All' style='cursor:pointer;'/></td>";
echo "<td width='30'>SN</td>";
echo "<td width='30'>Status</td>";
echo "<td align='left' style='padding-left:10px;'>features Title</td>";
echo "<td align='left' style='padding-left:10px;'>features Discription</td>";
echo "<td width: 50px;  width: 180px;'>features Image</td>";
// echo "<td align='left' style='padding-left:10px; width: 150px;'>features Created Date</td>";
// echo "<td align='left' style='padding-left:10px; width: 100px;'>Adress</td>";
...
echo "<td style='padding:5px; width:20px;' valign='top'>"; if($row['is_active']=="1"){?><span style="color:#009900">Active</span><?php } else {?><span style="color:#FF0000">Inactive</span><?php } echo"</td>";
echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'><b>$row[features_title]</b>"; ?> <a onClick="popupCenter('addfeatures?id=<?php echo $row['id'] ?>', 'myPop1',400,350);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php echo "</td>";

echo "</td>";
echo "<td style=' 'padding:2px; line-height:20px; width: 170px; text-align: justify;' valign='top'>$row[features_description]</td>";
// echo "<td valign='top' style='padding:2px; width:50px;'><a href='https://sanatanworld.org/assets/uploads/features/$row[features_image]' target='_blank'><img src='https://sanatanworld.org/assets/uploads/features/$row[features_image]' width='20' /></a><br/></td>";

echo "<td style='padding:5px;'>";?><a onClick="popupCenter('projectimage.php?folder=features&column=features_image&table=<?php echo $tbl_name ?>&w=500&h=500&id=<?php echo $row['id'] ?>', 'myPop1',450,500);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src="<?php echo $baseurl ?>/assets/uploads/features/<?php echo $row['features_image'] ?>" width="80" /></a><?php echo "</td>";



// echo "<td align='left' style='padding:5px;line-height:20px; width: 20px;' valign='top'><b>$row[created_at]</b></td>";
// echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'><b>$row[street_address]</b></td>";
