<?php include 'check.php'; $pageurl="madhi"; $tbl_name="madhi"; $mintablewidth="950px";  $utype="Madhi"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>Madhi Name</td>";  
