<?php include 'check.php'; $pageurl="facility"; $tbl_name="facility"; $mintablewidth="950px";  $utype="facility"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addfacility<?php echo $extn ?>', 'myPop1',350,250);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td align='left'>facility Name</td>";
echo "<td width: 20px; width: 75px;'>facility Icon</td>";
echo "<td style='padding-left:10px; width: 175px;'>facility Created Date</td>";
...
echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'><b>$row[facility_name]</b>"; ?><a onClick="popupCenter('addfacility?id=<?php echo $row['id'] ?>', 'myPop1',350,250);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php echo "</td>";

// echo "<td valign='top' style='padding:5px; width:60px;'><a href='https://sanatanworld.org/assets/uploads/facility_icon/$row[facility_icon]' target='_blank'><img src='https://sanatanworld.org/assets/uploads/facility_icon/$row[facility_icon]' width='40' /></a><br/></td>";
echo "<td style='padding:5px;'>";?><a onClick="popupCenter('projectimage.php?folder=facility_icon&column=facility_icon&table=<?php echo $tbl_name ?>&w=500&h=500&id=<?php echo $row['id'] ?>', 'myPop1',450,500);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src="<?php echo $baseurl ?>/assets/uploads/facility_icon/<?php echo $row['facility_icon'] ?>" width="80" /></a><?php echo "</td>";


echo "<td style='padding:5px;line-height:20px;' valign='top'><b>$row[created_at]</b></td>";
