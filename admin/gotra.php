<?php include 'check.php'; $pageurl="gotra"; $tbl_name="gotra"; $mintablewidth="950px";  $utype="Gotra"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>Gotra Name</td>";  
