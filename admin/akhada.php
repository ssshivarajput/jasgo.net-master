<?php include 'check.php'; $pageurl="akhada"; $tbl_name="akhada"; $mintablewidth="950px";  $utype="akhada"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>Akhada Name</td>";  
