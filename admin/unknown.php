<?php include 'check.php'; $pageurl="unknown_user"; $tbl_name="unknown_user"; $mintablewidth="950px";  $utype="unknown_user"; $pagename="$utype Details";
...
echo "<td style='padding:5px;line-height:20px; width:157px;' valign='top'><b>$row[email]</b>"; ?> <a onClick="popupCenter('addpost?id=<?php echo $row['id'] ?>', 'myPop1',520,600);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;">    <img src='images/edit.png' title='Edit'>
</a>
<?php 
