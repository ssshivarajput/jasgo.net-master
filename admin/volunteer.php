<?php error_reporting(E_ALL); ini_set('display_errors', 1);  include 'check.php'; $pageurl="volunteer"; $tbl_name="users"; $mintablewidth="950px";  $utype="USER"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addvolunteer<?php echo $extn ?>', 'myPop1',520,730);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
<?php $querym = "SELECT COUNT(*) as num FROM `$tbl_name` where is_deleted='Live' and user_type='$utype'"; $querymc = mysqli_fetch_array(mysqli_query($con,$querym)); $totalquery= $querymc['num']; echo $totalquery ?></b></div>
</div></div><!-- ./col --></a>   
</div>	
...
<div style='overflow-x: auto;'>
	...
	*/
	...
	$query = "SELECT COUNT(*) as num FROM `$tbl_name` WHERE is_deleted='Live'and user_type='$utype'";
    $sqlx = "SELECT * FROM `$tbl_name` WHERE is_deleted='Live' and user_type='$utype'"; 
...
echo "<td style='padding-left:10px;'>City</td>";
echo "<td style='padding-left:10px;'>State</td>";
echo "<td style='padding-left:10px;'>More Details</td>";
...
echo "<td style='padding:5px;line-height:20px; width:140px;' valign='top'>$row[city]</td>";
echo "<td style='padding:5px;line-height:20px; width:140px;' valign='top'>$row[state]</td>";

echo "</td>";

echo "<td style='padding:5px;line-height:20px;width:230px;' valign='top'>";
echo "<a onClick=\"popupCenter('addvolunteer?id={$row['id']}', 'myPop1',520,730);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\">View more</a>";
echo "<a onClick=\"popupCenter('addvolunteer?id={$row['id']}', 'myPop1',520,730);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\"><img src='images/edit.png' title='Edit'></a>";
echo "</td>";
// echo "<td><a href='{$row['test']}' target='_blank' style='color:#00F;'>View</a> / <a onClick=\"popupCenter('upload-image?id={$row['sessionid']}', 'myPop1',500,450);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\">Upload</a>";
echo "</td>";
echo "</tr>";
$tnum=$tnum-1; 	 
}
