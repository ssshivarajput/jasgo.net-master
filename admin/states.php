<?php include 'check.php'; $pageurl="states"; $tbl_name="states"; $mintablewidth="950px";  $utype="States"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>State Name</td>";  
