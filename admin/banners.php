<?php include 'check.php'; $pageurl="banners"; $tbl_name="banners"; $mintablewidth="950px";  $utype="banners"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addbanners<?php echo $extn ?>', 'myPop1',350,250);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td style='padding-left:10px;'>Banners Remark</td>";
echo "<td width:75px;'>banners Image</td>";

// echo "<td align='left' style='padding-left:10px; width: 180px;'>banners Discription</td>";

// echo "<td align='left' style='padding-left:10px; width: 150px;'>banners Created Date</td>";
...
echo "<td  style='padding:5px;line-height:20px;' valign='top'><b>$row[banner_remark]</b>"; ?><a onClick="popupCenter('addbanners?id=<?php echo $row['id'] ?>', 'myPop1',350,250);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php echo "</td>";


// echo "<td valign='top' style='padding:5px; width:26px;'><a href='https://sanatanworld.org/assets/uploads/banners/$row[banner_image]' target='_blank'><img src='https://sanatanworld.org/assets/uploads/banners/$row[banner_image]' width='80' /></a></td>";
echo "<td style='padding:5px;'>";?><a onClick="popupCenter('projectimage.php?folder=banners&column=banner_image&table=<?php echo $tbl_name ?>&w=500&h=500&id=<?php echo $row['id'] ?>', 'myPop1',450,500);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src="<?php echo $baseurl ?>/assets/uploads/banners/<?php echo $row['banner_image'] ?>" width="80" /></a><?php echo "</td>";
