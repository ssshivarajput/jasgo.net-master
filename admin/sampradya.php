<?php include 'check.php'; $pageurl="sampradya"; $tbl_name="sampradya"; $mintablewidth="950px";  $utype="Sampradya"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>Sampradya Name</td>";  
