<?php include 'check.php'; $pageurl="news"; $tbl_name="news"; $mintablewidth="950px";  $utype="news"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addnews<?php echo $extn ?>', 'myPop1',400,350);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td width='50'>SN</td>";
echo "<td width='100'>Status</td>";
echo "<td width: 110px;'>News Image</td>";
echo "<td align='left' style='padding-left:10px; width: 250px;'>News Title</td>";

echo "<td width: 50px;'>News Description</td>";

// echo "<td align='left' style='padding-left:10px; width: 150px;'>news Created Date</td>";
...
echo "<td valign='top' style='padding:5px;'><b>$in</b><br /><div style='height:6px;'></div><input type='checkbox' class='td' name =ids[] value='$row[id]' style='cursor:pointer;'></td>";
echo "<td style='padding:5px;' valign='top'>"; if($row['is_active']=="1"){?><span style="color:#009900">Active</span><?php } else {?><span style="color:#FF0000">Inactive</span><?php } echo"<br/>$row[created_at]</td>";
// echo "<td valign='top' style='padding:5px; width: 10%;'><a href='https://sanatanworld.org/assets/uploads/news/images/$row[news_image]' target='_blank'><img src='https://sanatanworld.org/assets/uploads/news/images/$row[news_image]' width='40' /></a><br/></td>";

echo "<td style='padding:5px;'>";?><a onClick="popupCenter('projectimage.php?folder=news/images&column=news_image&table=<?php echo $tbl_name ?>&w=500&h=500&id=<?php echo $row['id'] ?>', 'myPop1',450,500);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src="<?php echo $baseurl ?>/assets/uploads/news/images/<?php echo $row['news_image'] ?>" width="80" /></a><?php echo "</td>";


echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'>$row[news_title]"; ?><a onClick="popupCenter('addnews?id=<?php echo $row['id'] ?>', 'myPop1',400,350);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php echo "</td>";
echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'>$row[news_description]"; ?><?php echo "</td>";
