<?php include 'check.php'; $pageurl="sant"; $tbl_name="users"; $mintablewidth="950px";  $utype="SAINT"; $pagename="$utype Details";
$page = @$_GET['page']; 
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addsant<?php echo $extn ?>', 'myPop1',520,730);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td align='left' style='padding-left:10px;'>Sant name</td>";
...
echo "<a onClick=\"popupCenter('addsant?id={$row['id']}', 'myPop1',520,730);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\">View more</a>";
echo "<a onClick=\"popupCenter('addsant?id={$row['id']}', 'myPop1',520,730);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\"><img src='images/edit.png' title='Edit'></a>";
echo "</td>";
$tnum=$tnum-1; 	 
}
