<?php include 'check.php'; $pageurl="saint"; $tbl_name="features"; $mintablewidth="950px";  $utype="Feature"; $pagename="$utype Details";
...
echo "<td width='84'>Image</td>";
echo "<td align='left' style='padding-left:10px;'>Notification Details</td>";
echo "</tr>";
...
echo "<td valign='top' style='padding:5px;'><a href='https://sanatanworld.org/assets/uploads/notification/$row[image_url]' target='_blank'><img src='https://sanatanworld.org/assets/uploads/notification/$row[image_url]' width='80' /></a><br /><div style='height:4px;'></div>$rdx</td>";
echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'><b>$row[title]</b>"; ?> <a onClick="popupCenter('addnotification?id=<?php echo $row['id'] ?>', 'myPop1',520,600);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php echo "<br />$row[description]</td>";
