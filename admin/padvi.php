<?php include 'check.php'; $pageurl="padvi"; $tbl_name="padvi"; $mintablewidth="950px";  $utype="Padvi"; $pagename="$utype Details";
...
echo "<td align='left' style='padding-left:10px;'>Padvi Name</td>";  
