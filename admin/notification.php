<?php include 'check.php'; $pageurl="notification"; $tbl_name="tbl_notification"; $mintablewidth="950px";  $utype="Notification"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addnotification<?php echo $extn ?>', 'myPop1',400,350);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td align='left' style='padding-left:10px;'>Notification Subject</td>";
echo "<td style='padding-left:10px;'>Date</td>";
echo "<td style='padding-left:10px;'>Time</td>";
echo "<td style='padding-left:10px;'>More Details</td>";

// echo "<td width='84'>News Image</td>";
// echo "<td align='left' style='padding-left:10px;'>News Description</td>";
echo "</tr>";
...
echo "<td valign='top' style='padding:5px;'><b>$in</b><br /><div style='height:6px;'></div></td>";
echo "<td valign='top' style='padding:5px;'>";
?>
<a onClick="popupCenter('projectimage.php?folder=notification&column=image_url&table=<?php echo $tbl_name ?>&w=640&h=360&id=<?php echo $row['id'] ?>', 'myPop1',450,500);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src="<?php echo $baseurl ?>/assets/uploads/notification/<?php echo $row['image_url'] ?>" width="80" /></a><br /><div style='height:4px;'></div>
<?php
echo "</td>";
echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'><b>$row[title]</b>"; ?><?php echo "<br />$row[description]</td>";

echo "<td valign='top' style='padding:5px;'><b>$date</b><br /><div style='height:6px;'></div></td>";
echo "<td valign='top' style='padding:5px;'><b>$time</b><br /><div style='height:6px;'></div></td>";echo "</td>";
echo "<td style='padding:5px;line-height:20px;width:170px;' valign='top'>";
echo "<a onClick=\"popupCenter('addnotification?id={$row['id']}', 'myPop1',520,730);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\">View more</a>";
echo "<a onClick=\"popupCenter('addnotification?id={$row['id']}', 'myPop1',520,730);\" href=\"javascript:void(0);\" style=\"text-decoration:none;color:#00F; cursor:pointer;\"><img src='images/edit.png' title='Edit'></a>";
echo "</td>";                                                                                         
