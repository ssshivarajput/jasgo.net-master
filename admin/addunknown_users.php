...
$pageurl = "addunknown_users"; 
$tbl_name = "unknown_user"; 
...
if(isset($_GET['mode']) && $_GET['mode'] == "create_new"){
    ...
    if (!empty($tbl_name)) {
        $sql = "INSERT INTO `$tbl_name`(`is_active`,  `email`, `mobile_no`,`is_deleted`, `created_at`) 
                VALUES ('1','$email', '$mobile_no', 'Live', '$created_at')";
    ...
    $sql = "UPDATE `$tbl_name` SET email='$email', mobile_no='$mobile_no', WHERE id ='".$_GET['id']."'";
