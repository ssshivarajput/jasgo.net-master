<?php include 'check.php'; $pageurl="post"; $tbl_name="tbl_post"; $mintablewidth="950px";  $utype="Post"; $pagename="$utype Details";
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addpost<?php echo $extn ?>', 'myPop1',400,350);" href="javascript:void(0);" style="color:#0000FF; text-transform:uppercase"><button type="button" class="btn btn-success btn-sm"><i class='fa fa-plus-square'></i> CREATE<span class="hidem"> NEW <?php echo strtoupper($utype) ?></span></button></a> </td>
...
echo "<td width='110'>Image</td>";  
echo "<td align='left' style='padding-left:10px;'>Title</td>";
echo "<td align='left' style='padding-left:10px; width: 140px;'>Description</td>";
...
// <a href='https://sanatanworld.org/assets/uploads/post/$row[image_url]' target='_blank'><img src='https://sanatanworld.org/assets/uploads/post/$row[image_url]' width='80' /></a></td>";


echo "<td style='padding:5px;'>";?><a onClick="popupCenter('projectimage.php?folder=post&column=image_url&table=<?php echo $tbl_name ?>&w=500&h=500&id=<?php echo $row['id'] ?>', 'myPop1',450,500);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src="<?php echo $baseurl ?>/assets/uploads/post/<?php echo $row['image_url'] ?>" width="80" /></a><?php echo "</td>";


echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'><b>$row[title]</b>"; ?> 
<a onClick="popupCenter('addpost?id=<?php echo $row['id'] ?>', 'myPop1',400,350);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php echo "</td>";

echo "</td>";
echo "<td align='left' style='padding:5px;line-height:20px;' valign='top'>$row[description]</td>";
