<?php include 'check.php'; $pageurl="donation-details"; $tbl_name="donation_details"; $mintablewidth="950px";  $utype="DONATION"; $pagename="$utype Details";
$page = @$_GET['page']; 
...
echo "<td align='left' style='padding-left:10px;'>Donor name</td>";
echo "<td style='padding-left:10px;'>Donation</td>";
...
echo "<td align='left' style='padding:5px;line-height:20px; width:140px;' valign='top'><b>$row[donor_name]</b></td>";
echo "<td align='left' style='padding:5px;line-height:20px; width:140px;' valign='top'><b>$row[amount]</b></td>";
echo "<td style='padding:5px;line-height:20px;' valign='top'>$row[donor_email]</td>";
echo "<td style='padding:5px;line-height:20px; width:140px;' valign='top'>$row[mobile_number]</td>";
