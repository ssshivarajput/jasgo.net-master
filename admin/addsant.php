...
if (isset($_GET['mode']) && $_GET['mode'] == 'create_new') {
    ...
    $guru_name = $con->real_escape_string($_POST['guru_name']);
    $email = $con->real_escape_string($_POST['email']);
    $mobile_no = $con->real_escape_string($_POST['mobile_no']);
    $sampraday = $con->real_escape_string($_POST['sampraday']);
    $padvi = $con->real_escape_string($_POST['padvi']);
    $madhi = $con->real_escape_string($_POST['madhi']);
    $akhada = $con->real_escape_string($_POST['akhada']);
 ...
 <body class="<?php echo $skincolor; ?>">
   ...
   <form name="form1" id="form1" action="<?php echo $pageurl; ?>?mode=<?php echo isset($_GET['id']) ? 'update' : 'create_new'; ?>&pagename=<?php echo $pagename; ?>&id=<?php echo @$_GET['id']; ?>&tbl_name=<?php echo $tbl_name; ?>" method="post">
        <div align="center">
            ...
            <icon class="btn bg-white margin">
                <label>Guru Name<span style="color:#FF0000"></span></label>
                <input type="text" name="guru_name" value="<?php echo $guru_name; ?>" class="form-control" style="width:200px;" />
            </icon>	
            <icon class="btn bg-white margin">
            ...
            <icon class="btn bg-white margin">
                <label>Sampraday<span style="color:#FF0000"></span></label>
                <input type="text" name="sampraday" value="<?php echo $sampraday; ?>" class="form-control"  style="width:200px;" />
            </icon>	 
            <icon class="btn bg-white margin">
                <label>Padvi<span style="color:#FF0000"></span></label>
                <input type="text" name="padvi" value="<?php echo $padvi; ?>" class="form-control" style="width:200px;" />
            </icon>	
              <icon class="btn bg-white margin">
                <label>Madhi<span style="color:#FF0000"></span></label>
                <input type="text" name="madhi" value="<?php echo $madhi; ?>" class="form-control"  style="width:200px;" />
            </icon>	
               <icon class="btn bg-white margin">
                <label>Akhada<span style="color:#FF0000"></span></label>
                <input type="text" name="akhada" value="<?php echo $akhada; ?>" class="form-control"  style="width:200px;" />
            </icon>	
    ...
    foreach ($designation as $key => $value) { ?>
        <option value="<?php echo $value['name']; ?>" <?php if ($value['name'] == $inchargename) {
            echo 'selected';
        } ?>>
            <?php echo $value['name']; ?>
        </option>
    <?php } ?>
            ...
            <icon class="btn bg-white margin">
                ...
                <select class="form-control" name="inchargedesignation" style="width:200px;>
                        ...
                        <?php foreach ($designation as $key => $value) { ?>
                            <option value="<?php echo $value['designation']; ?>" <?php if ($value['designation'] == $inchargedesignation) {
                                echo 'selected';
                            } ?>>
            ...
            <icon class="btn bg-white margin">
                ...
                <select class="form-control" name="inchargestate" style="width:200px;>
                        ...
                        <?php foreach ($designation as $key => $value) { ?>
                            <option value="<?php echo $value['state_name']; ?>" <?php if ($value['state_name'] == $inchargestate) {
                                echo 'selected';
                            } ?>>
